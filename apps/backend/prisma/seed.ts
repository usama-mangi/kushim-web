...
import { seedISO27001 } from './seeds/iso27001.seed';
import { seedHIPAA } from './seeds/hipaa.seed';
import { seedPCIDSS } from './seeds/pcidss.seed';
import { seedFrameworkMappings } from './seeds/framework-mappings.seed';

const prisma = new PrismaClient();

async function seedSOC2Controls() {
  console.log('\nSeeding SOC 2 controls...');
  ...
  // All 64 SOC 2 controls from the original seed
  const controls = [
    ...
    // CC6: Logical and Physical Access (Add all remaining controls from original file...)
    {
      frameworkId: framework.id,
    ...
    // CC7: System Operations (continue with remaining controls from original seed.ts...)
    {
      frameworkId: framework.id,
      sectionId: sectionMap['CC7'],
      controlId: 'CC7.1.1',
...
async function main() {
  console.log('Starting multi-framework seed...\n');
  ...
  console.log('\n✅ Multi-framework seeding completed!');
}
